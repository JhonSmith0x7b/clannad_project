...
def hello():
	...
	if action != '' and chapter != '':
		if action == 'readnovel':
			...
			return render_template('clannad_novel/main.htm', action = 'readnovel', content = content), 
			200, {'Content-Type': 'text/html;charset=utf-8'}
	return render_template('clannad_novel/main.htm'), 
	200, {'Content-Type': 'text/html;charset=utf-8'}
...
class Novel_reader:
	def __init__(self, chapter = 'fuuko'):
		self.f = open(('%s/static/txt/%s.txt') % (current_app.root_path, chapter), 'r')
		pass
